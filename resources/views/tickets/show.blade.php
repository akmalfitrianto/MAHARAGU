...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <div class="bg-gradient-to-r from-teal-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
        <div class="flex items-start justify-between">
            ...
            <span class="px-4 py-2 text-sm font-medium rounded-full {{ $ticket->status === 'open' ? 'bg-blue-500' : ($ticket->status === 'in_progress' ? 'bg-yellow-500' : ($ticket->status === 'resolved' ? 'bg-green-500' : 'bg-gray-500')) }}">
                {{ $ticket->status_label }}
            </span>
        </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="p-3 bg-gray-50 rounded-lg">
                            <p class="font-medium text-gray-900">{{ $ticket->accessPoint->room->floor->building->name }}</p>
