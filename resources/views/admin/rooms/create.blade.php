...
<div class="max-w-6xl mx-auto">
    ...
    <nav class="flex mb-6" aria-label="Breadcrumb">
        <ol class="flex items-center space-x-2 text-sm">
            ...
            <li>
                <a href="{{ route('admin.buildings.show', $floor->building) }}" class="text-gray-500 hover:text-gray-700">{{ $floor->building->name }}</a>
            </li>
            <li>
                <svg class="w-4 h-4 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
            ...
            <li>
                <a href="{{ route('admin.floors.rooms.index', $floor) }}" class="text-gray-500 hover:text-gray-700">{{ $floor->display_name }}</a>
            </li>
            <li>
                <svg class="w-4 h-4 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
    ...
    <form method="POST" action="{{ route('admin.floors.rooms.store', $floor) }}" class="space-y-6" x-data="roomForm()">
        @csrf
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-6">
                ...
                <div x-show="shape_type === 'custom'" x-cloak>
                    ...
                    <textarea name="svg_path" 
                              x-model="svg_path"
                              rows="3"
                              placeholder="M 100 200 L 100 100..."
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg text-sm text-blue-800">
                    ...
                    <ul class="list-disc list-inside space-y-1 text-xs">
                        <li>Canvas size: 1000x600 px untuk denah lantai</li>
                        <li>Setelah ruangan dibuat, Anda bisa menambahkan Access Point</li>
                        <li>Preview akan update otomatis saat Anda mengubah nilai</li>
                    </ul>
                </div>
            </div>
        </div>
