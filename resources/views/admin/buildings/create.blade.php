...
@section('content')
    ...
    <div class="max-w-6xl mx-auto">
        <nav class="flex mb-6" aria-label="Breadcrumb">
            <ol class="flex items-center space-x-2 text-sm">
                ...
                <li><span class="text-gray-900 font-medium">Tambah Gedung</span></li>
            </ol>
        </nav>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-6">
                    ...
                    <div class="flex space-x-3 pt-4 border-t border-gray-200">
                        ...
                        <button type="submit"
                            class="flex-1 px-6 py-3 bg-teal-500 text-white font-medium rounded-lg hover:bg-teal-600 transition shadow-lg hover:shadow-xl">Simpan
                            Gedung</button>
                    </div>
                </div>
    ...
    <script>
        function buildingForm() {
            return {
                name: '{{ old('name') }}',
                total_floors: {{ old('total_floors', 1) }},
                shape_type: '{{ old('shape_type', 'rectangle') }}',
                svg_path: `{!! old('svg_path') !!}`,
                width: {{ old('width', 150) }},
                height: {{ old('height', 200) }},
                position_x: {{ old('position_x', 200) }},
                position_y: {{ old('position_y', 150) }},
                color: '{{ old('color', '#c2c2c2') }}',
